...
export const BOSS_NAMES = [JAILOR_BOSS_NAME, BRIAR_REVENANT_BOSS_NAME, PRIMAL_CONFLUX_BOSS_NAME, JUGGERNAUT_BOSS_NAME, TERRORBOT_BOSS_NAME, ICE_GOLEM_BOSS_NAME, BOSS_NAME] as const;
