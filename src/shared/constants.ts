...
export const ICE_GOLEM_BOSS_NAME = "Ice Golem";
export const KRAKEN_BOSS_NAME = "Kraken";
export const KRAKEN_BOSS_HP_MULT = 2.2;
export const KRAKEN_BOSS_RADIUS = 42;
export const KRAKEN_SLAM_RANGE = 100;
export const KRAKEN_SLAM_CD = 1450;
export const KRAKEN_SLAM_WINDUP_MS = 620;
export const KRAKEN_SLAM_DMG = Math.round(BOSS_MELEE_DMG * 1.75);
export const KRAKEN_SWEEP_RANGE = 165;
export const KRAKEN_SWEEP_CD = 2300;
export const KRAKEN_SWEEP_WINDUP_MS = 700;
export const KRAKEN_SWEEP_DMG = Math.round(BOSS_MELEE_DMG * 0.85);
export const BOSS_NAMES = [JAILOR_BOSS_NAME, BRIAR_REVENANT_BOSS_NAME, PRIMAL_CONFLUX_BOSS_NAME, JUGGERNAUT_BOSS_NAME, TERRORBOT_BOSS_NAME, ICE_GOLEM_BOSS_NAME, KRAKEN_BOSS_NAME, BOSS_NAME] as const;
