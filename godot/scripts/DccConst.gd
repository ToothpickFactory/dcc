...
const KRAKEN_BOSS_RADIUS := 42.0
const MONSTER_RADIUS_GRUNT := 22.0
const MONSTER_RADIUS_BRUTE := 40.0
const MONSTER_RADIUS_SWARM := 13.0
const MONSTER_RADIUS_PIRATE := 22.0
const MONSTER_RADIUS_SHARKMAN := 30.0
const MONSTER_RADIUS_RANGED := 20.0
const MONSTER_RADIUS_HEALER := 20.0
...
const PROTOCOL_VERSION := 28  # v28: optional opaque mask for see-through blocked cells
