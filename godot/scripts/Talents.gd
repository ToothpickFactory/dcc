...
const TREES := {
	"warrior": [
		...
		{"id": "w_tough", "row": 0, "choiceGroup": "w_spec", "name": "Toughness", "icon": "\U01f6e1️", "desc": "Tank: +armor/stamina and 3× threat."},
	...
	"mage": [
		...
		{"id": "m_pyro", "row": 0, "choiceGroup": "m_spec", "name": "Pyromania", "icon": "\U01f525", "desc": "+intellect and +crit."},
	...
	"priest": [
		...
		{"id": "p_holy", "row": 0, "choiceGroup": "p_spec", "name": "Holy Light", "icon": "\U01f31f", "desc": "+intellect (stronger heals)."},
		{"id": "p_div", "row": 0, "choiceGroup": "p_spec", "name": "Divinity", "icon": "\U01f54a️", "desc": "+intellect and +stamina."},
	...
	"hunter": [
		...
		{"id": "h_mark", "row": 0, "choiceGroup": "h_spec", "name": "Marksman", "icon": "\U01f3f9", "desc": "+agility and +crit."},
