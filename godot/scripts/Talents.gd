...
const CLASS_INFO := {
	...
	"mage": {"name": "Mage", "icon": "\U01f52e", "armor": "Cloth", "blurb": "Glass-cannon spellcaster. Intellect powers ranged bolts and a group haste burst."},
	...
	"rogue": {"name": "Rogue", "icon": "\U01f5e1️", "armor": "Leather", "blurb": "Agile melee assassin. Agility and crit turn fast strikes into bursts of damage."},
	"hunter": {"name": "Hunter", "icon": "\U01f3f9", "armor": "Mail", "blurb": "Ranged marksman. Agility drives volleys of thrown shots from a safe distance."},
}

# Per-class talent trees: each node {id,row,requires?,choiceGroup?,name,icon,desc}.
const TREES := {
	"warrior": [
		{"id": "w_cleave", "row": 0, "name": "Cleave", "icon": "\U01f52a", "desc": "Unlock Iron Cleaver."},
		{"id": "w_tough", "row": 0, "choiceGroup": "w_spec", "maxRank": 2, "name": "Toughness", "icon": "\U01f6e1️", "desc": "Tank: +armor/stamina and 3× threat. (2 ranks)"},
		{"id": "w_blood", "row": 0, "choiceGroup": "w_spec", "maxRank": 2, "name": "Bloodthirst", "icon": "\U01fa78", "desc": "DPS: +strength and +crit. (2 ranks)"},
		...
		{"id": "w_master", "row": 3, "requires": 6, "maxRank": 3, "name": "Warmastery", "icon": "⚔️", "desc": "+strength per rank. (3 ranks)"},
	],
	"mage": [
		{"id": "m_bolts", "row": 0, "name": "Arcane Bolts", "icon": "\U01f537", "desc": "Unlock sharper ranged bolts."},
		{"id": "m_pyro", "row": 0, "choiceGroup": "m_spec", "maxRank": 2, "name": "Pyromania", "icon": "\U01f525", "desc": "+intellect and +crit. (2 ranks)"},
		{"id": "m_weave", "row": 0, "choiceGroup": "m_spec", "maxRank": 2, "name": "Spellweave", "icon": "\U01f30c", "desc": "+intellect (steady power). (2 ranks)"},
		...
		{"id": "m_master", "row": 3, "requires": 6, "maxRank": 3, "name": "Arcane Mastery", "icon": "\U01f52e", "desc": "+intellect per rank. (3 ranks)"},
	],
	"priest": [
		{"id": "p_mend", "row": 0, "name": "Mend", "icon": "✨", "desc": "Unlock a healing bolt (allies only)."},
		{"id": "p_holy", "row": 0, "choiceGroup": "p_spec", "maxRank": 2, "name": "Holy Light", "icon": "\U01f31f", "desc": "+intellect (stronger heals). (2 ranks)"},
		{"id": "p_div", "row": 0, "choiceGroup": "p_spec", "maxRank": 2, "name": "Divinity", "icon": "\U01f54a️", "desc": "+intellect and +stamina. (2 ranks)"},
		{"id": "p_shield", "row": 1, "requires": 2, "name": "Power Word: Shield", "icon": "\U01f6e1️", "desc": "Unlock an ally absorb shield."},
		{"id": "p_inspire", "row": 1, "requires": 2, "name": "Inspire", "icon": "\U01fa78", "desc": "Unlock a group haste burst."},
		{"id": "p_wave", "row": 2, "requires": 4, "name": "Wave of Mending", "icon": "\U01f30a", "desc": "Capstone: heal several allies."},
		{"id": "p_master", "row": 3, "requires": 6, "maxRank": 3, "name": "Zeal", "icon": "\U01f54a️", "desc": "+intellect/stamina per rank. (3 ranks)"},
	],
	"rogue": [
		{"id": "r_strike", "row": 0, "name": "Quick Strikes", "icon": "\U01f52a", "desc": "Unlock faster melee strikes."},
		{"id": "r_deadly", "row": 0, "choiceGroup": "r_spec", "maxRank": 2, "name": "Deadliness", "icon": "☠️", "desc": "+agility and +crit. (2 ranks)"},
		{"id": "r_swift", "row": 0, "choiceGroup": "r_spec", "maxRank": 2, "name": "Swiftness", "icon": "\U01f4a8", "desc": "+agility (speed + power). (2 ranks)"},
		...
		{"id": "r_master", "row": 3, "requires": 6, "maxRank": 3, "name": "Finesse", "icon": "\U01f5e1️", "desc": "+agility per rank. (3 ranks)"},
	],
	"hunter": [
		{"id": "h_aim", "row": 0, "name": "Steady Aim", "icon": "\U01f3af", "desc": "Unlock sharper shots."},
		{"id": "h_mark", "row": 0, "choiceGroup": "h_spec", "maxRank": 2, "name": "Marksman", "icon": "\U01f3f9", "desc": "+agility and +crit. (2 ranks)"},
		{"id": "h_swift", "row": 0, "choiceGroup": "h_spec", "maxRank": 2, "name": "Fleet", "icon": "\U01f4a8", "desc": "+agility (speed + power). (2 ranks)"},
		...
		{"id": "h_master", "row": 3, "requires": 6, "maxRank": 3, "name": "Precision", "icon": "\U01f3f9", "desc": "+agility/crit per rank. (3 ranks)"},
	],
}
